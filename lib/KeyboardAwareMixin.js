...
const KeyboardAwareMixin = {
  ...
  updateKeyboardSpace: function (frames: Object) {
    const frameEnd = frames.endCoordinates || frames.end
    const keyboardSpace = (this.props.viewIsInsideTabBar) ? frameEnd.height - _KAM_DEFAULT_TAB_BAR_HEIGHT : frameEnd.height
    this.setState({
